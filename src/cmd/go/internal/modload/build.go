...
func PackageModuleInfo(pkgpath string) *modinfo.ModulePublic {
	...
	return moduleInfoFromBuildList(m)
}
...
func moduleInfoFromBuildList(m module.Version) *modinfo.ModulePublic {
	// cmd/go doesn't need to do much work if the module is in the build list,
	// so pass in a TODO for now.
